...
export default function InsufficientRole() {
  ...
  const styles = {
    ...
    iconContainer: {
      ...
      borderRadius: '50%',
      background: isDarkMode ? '#2a2a1a' : '#fffbeb',
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
      border: `2px solid ${isDarkMode ? '#4a4a2a' : '#fde68a'}`,
    },
    title: {
      fontSize: '1.75rem',
      fontWeight: 700,
    ...
    infoBox: {
      background: isDarkMode ? '#1a2a1a' : '#f0fdf4',
      padding: '1.25rem',
      borderRadius: '12px',
      marginBottom: '1.5rem',
      border: `1px solid ${isDarkMode ? '#2a4a2a' : '#bbf7d0'}`,
    },
    infoText: {
      color: isDarkMode ? '#a0c0a0' : '#166534',
      fontSize: '0.9rem',
      margin: 0,
      lineHeight: 1.6,
    },
  ...
  return (
    <>
      <Head>
        <title>Insufficient Role - Ask Dr Chaffee</title>
        <meta name="description" content="You need a specific role to access this application." />
      </Head>
      ...
      <div style={styles.container}>
        <div style={styles.card}>
          ...
          <p style={styles.subtitle}>
            You're a member of our Discord server, but you don't have the required role to access Ask Dr Chaffee.
          </p>

          <div style={styles.infoBox}>
            <p style={styles.infoText}>
              🔑 Access to this application requires a specific role in the Discord server. 
              Please contact a server administrator or check the server's role requirements.
            </p>
          </div>

          {/* Placeholder for Discord server link */}
          <a 
            href="#" 
