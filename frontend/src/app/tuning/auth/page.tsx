...
/**
 * Tuning Dashboard Authentication Page
 * 
 * This is a PASSWORD-ONLY authentication page for the internal admin dashboard.
 * Discord OAuth is NOT supported here - it's only for the main user-facing app.
 * 
 * Authentication flow:
 * 1. User enters admin password
 * 2. Password is verified via /api/tuning/auth/verify
 * 3. On success, tuning_auth=authenticated cookie is set
 * 4. User is redirected to /tuning
 */
